...
const dollar = await stdlib.launchToken(accCreator, "Dollar", "USD");
...
if ( await doSwap(dollar, amtA, naira, amtB, false)
     && await doSwap(naira, amtB, dollar, amtA, false) ) {
  await doSwap(dollar, amtA, naira, amtB, true);
}